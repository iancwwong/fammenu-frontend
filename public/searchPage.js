...
var SearchResults = function SearchResults(props) {
    return React.createElement(
        ...
        React.createElement(
            'ul',
            null,
            props.foundFoodItems.map(function (foodItem) {
                return React.createElement(
                    'li',
                    { key: foodItem.id },
...
var FoodItem = props > React.createElement(
    'div',
    null,
    React.createElement(
        'ul',
        ...
        React.createElement(
            'li',
            { key: props.foodItem.id + props.foodItem.name },
            props.foodItem.name
        ),
        React.createElement(
            'li',
            { key: props.foodItem.id + props.foodItem.cuisine },
            props.foodItem.cuisine
        )
    )
);
